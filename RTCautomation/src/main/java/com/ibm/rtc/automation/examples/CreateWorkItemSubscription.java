 ...
 */
public class CreateWorkItemSubscription {
	...
	private static class CreateAndSubscribeWorkItem extends WorkItemOperation {
		...
		public CreateAndSubscribeWorkItem(String summary,
				ICategoryHandle category, ITeamRepository teamRepository,
	...
	private static boolean run(String[] args) throws TeamRepositoryException {
		...
		if (args.length != 8) {
			System.out
					.println("Usage: CreateWorkItemApproval [repositoryURI] [userId] [password] [projectArea] [workItemType] [summary] [category] [subscriberUserID]");
		...
		CreateAndSubscribeWorkItem operation = new CreateAndSubscribeWorkItem(
				summary, category, teamRepository, approverUserID);
