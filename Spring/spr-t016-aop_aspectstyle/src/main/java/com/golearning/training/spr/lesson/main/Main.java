...
public class Main {
	...
	public static void main(String[] args) {
		...
		IShopCartSrv cartSrv = (IShopCartSrv)ctx.getBean("shopCartSrv");
		cartSrv.buy(new ArrayList<Book>());
		cartSrv.getBooks();
		...
		cartSrv.deleteBook(null);
		((INamedService)cartSrv).setName("Cart Service");
		((INamedService)cartSrv).getName();
	}
